...
| C7 | Exact model IDs, token limits, seeds, separate 5,000-resample human analysis, provider-resource limits and human-study documentation limits disclosed. Voluntary agreement, non-payment and lack of formal institutional ethics/IRB review are reported exactly; external artifact access is not invented. | Reporting fixed; external access remains unresolved |
...
Authors must review the disclosed participant and ethics facts and the asset-license inventory before making submission declarations.
The checklist reports that the unpaid co-author voluntarily agreed after risk disclosure and that no formal institutional ethics/IRB review or approval was obtained. External reproducibility still requires an authorized anonymous artifact-access arrangement; none is represented as already established.
